...
public class NewsController
{
	...
	@RequestMapping("to_index_news")
	public String to_index_news(HttpServletRequest request){
		logger.info("["+this.getClass().getName()+"][to_index_news][start]");
		
		List<NewsEntity>  list = newsService.getAll();

		logger.info("["+this.getClass().getName()+"][to_index_news][end]--goto[news/index_news.jsp]");
		return "news/index_news";
	}
