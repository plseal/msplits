...
<div class="container">
	...
	<div class="row">
		<br/><br/><br/>
		<a href="javascript:gobackToSecurityCheckIndex();"  class="button button-block button-rounded button-primary button-large">完成</a>
	</div>
	...
	<script>
		...
		function gobackToSecurityCheckIndex(){
			
		
			document.all.myform.action="${pageContext.request.contextPath}/admin/to_securityCheck.do";
