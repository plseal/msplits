...
<div class="container">
	...
	<div class="col-md-3">
	<%=request.getParameter("strSecurityCheckView").toString() %>
	
	<input type = "hidden" id = "securityCheck_beSelected_type" value = '<%=request.getParameter("strSecurityCheckView").toString() %>'>
	</div>
	<div class="row">
		<br/>
    	<br/>
...
function uploadFile(){
	...
	if (file_name == ""){
		...
		document.all.myform.action="${pageContext.request.contextPath}/uploadFile/uploadSecurityCheckFile.do?securityCheck_beSelected_type="+document.all.securityCheck_beSelected_type.value;
