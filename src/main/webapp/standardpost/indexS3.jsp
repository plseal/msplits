...
<div class="container">
	...
	<div class="row">
		<br/><br/><br/>
		<a href="javascript:gobackToStandardpostIndex();"  class="button button-block button-rounded button-primary button-large">完成</a>
	</div>
	...
	<script>
		...
		function gobackToStandardpostIndex(){
			
		
			document.all.myform.action="${pageContext.request.contextPath}/admin/to_standardpost.do";
